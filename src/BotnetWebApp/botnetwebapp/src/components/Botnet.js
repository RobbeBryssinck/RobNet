...
const BotnetsUri = "https://localhost:32800/api/v1/Botnets/";
const BotnetJobsUri = "https://localhost:32802/api/v1/Botnetjob/";

function Botnet() {
  console.log(BotnetsUri);
  console.log(BotnetJobsUri);
